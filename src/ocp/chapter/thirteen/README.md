...
### Marking Methods with _@Override_
...
### Declaring Interfaces with _@FunctionalInterface_
...
### Retiring Code with _@Deprecated_
...
### Ignoring Warnings with _@SuppressWarnings_
...
- "unchecked": Ignore warnings related to the use of raw types, shuch as List instead of List<_String_>.
